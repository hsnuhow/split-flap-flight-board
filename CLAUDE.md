...
> 依 `OpDev/standards/DEPLOYMENT.md` 第七節撰寫。**全專案只有這一節，沒有第二處例外宣告。**

### 刻意例外 2026-09-10-A：純顯示前端，豁免跨專案治理骨架

> 2026-09-10 宣告，2026-09-11 修訂。四條件（理由／失效條件／涵蓋範圍＋日期式識別碼）齊備。
...
### 刻意例外 2026-09-11-A：啟用「單人專案的簡化授權」

> 依第七節的豁免，本則只需以下三句，不受四條件約束。
